...
const Navbar: React.FC<NavbarProps> = ({ onSearch, activeCategory, onCategoryChange, onGoHome }) => {
  const categories: GameCategory[] = ['All', 'Action', 'Puzzle', 'Sports', 'Strategy', 'Retro', 'Idle'];
